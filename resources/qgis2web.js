...
map.getView().fit([2311776.118209, -20681803.532437, 12551663.635124, -808482.581696], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Jangkauan Halte Kecamatan Genteng</h2>';
        return titleElement;
    })(),
